...
# 方式 A: 从 GitHub 克隆（推荐）
git clone https://github.com/YOUR_USERNAME/cardshopdir-workspace.git
cd cardshopdir-workspace/cardshopdir

# 方式 B: 从本地上传（如果没有 GitHub 仓库）
# 在本地 Mac 上执行：
# scp -r /Users/tangsir/work/source_code/cardshopdir-workspace root@31.220.31.224:/var/www/
```
...
```bash
cd /var/www/cardshopdir-workspace/cardshopdir
bun install
```
...
#   root@31.220.31.224:/var/www/cardshopdir-workspace/data/
